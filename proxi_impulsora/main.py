...
JSON_AGENCIA = r"C:\Users\infob\Desktop\inventarios\agencias\impulsora\inventario_render.json"
...
@app.route("/")
def home():
    return "Servidor PROXI JQ Motors IMPULSORA activo."
...
def actualizar_desde_matriz():
    ...
    inventario_final = [{"codigo": i.get("codigo",""), "descripcion": i.get("descripcion",""), "stock": i.get("stock",0), "agencia": "impulsora"} for i in inventario_real]
    guardar_inventario(inventario_final)
    return jsonify({"status": "actualizado"})
